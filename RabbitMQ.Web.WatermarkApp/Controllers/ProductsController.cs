...
namespace RabbitMQ.Web.WatermarkApp.Controllers
{
    public class ProductsController : Controller  //bunu controller oluştururken mvc tarafında view da oluştur ile oluşturduk otomatik geldi bu kodlar
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Price,Stock,ImageName")] Product product, IFormFile ImageFile)
        {
            ...
            if (ImageFile is { Length: > 0 })
            {
                ...
                _rabbitMQPublisher.Publish(new ProductImageCreated()
                {
